  ...
  constructor(props) {
    ...
    login =()=>{
      ...
      if(this.state.password == ''){
        ...
        this.props.loginAction(this.api_url,username, password);
      }
  ...
  render(){
    ...
    return (
      <View style={styles.container}>
       ...
       />: 
             <ImageBackground style={styles.back} source={require('../assets/banners/loginbanner.jpg')} >
      <View style={styles.container}>
       <Image style={styles.tinyLogo} source={require('../assets/logo_green_large.png')} /> 
     
          <Text style={{color:'red', fontWeight:"bold", fontSize:16, padding:10 }}>{this.state.errorMsg}</Text>
...
<Switch
  ...
  <Text style={styles.label}>Remember Me</Text>
        ...
        <TouchableOpacity style={styles.loginBtn} onPress={() => this.login()}>
             <Text style={styles.loginText}>{isLoading?<ActivityIndicator color="white" size="small" />:'Login'}</Text> 
        </TouchableOpacity>
