...
const SponsorCardFav = (props) => {
  ...
  useEffect(() => {
    ...
    Axios.post(`${api_url.myFavourites}`, formData).then((res) => {
      ...
      setFavourites(res.data.sponsor ? res.data.sponsor : []);
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                Axios.post(`${api_url.sponsorDetail}`, formDataUser).then(
                  (res) => {
                    console.log("sponsor fav res", res);
                ...
                // navigation.navigate("SponsorDetail", { sponsor_id: fav.sponsor_id })
              }}
            >
...
export default connect(mapStateToProps)(SponsorCardFav);
