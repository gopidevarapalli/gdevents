        ...
        <List.Section>
          {AgendaData.map((agenda,i)=>{
            ...
            left={props => <List.Icon {...props} icon="folder" />}>
              ...
              {agenda.events.Track2?<View>
                <Text style={{
                  fontWeight:"bold",
                  color:"white",
                  backgroundColor:"#C21383",
                  textAlign:"center",
                  padding:10
              ...
              {agenda.events.Track1?agenda.events.Track1.map((evnt,j) =>{
                        return (
                          
                        <TouchableOpacity style={styles.card} key={j} onPress={()=> navigation.navigate('AgendaDetails',{id:evnt.agend_id, provider: evnt.provider})}> 
              ...
              {agenda.events.Track2?agenda.events.Track2.map((evnt,j) =>{
                        return (
