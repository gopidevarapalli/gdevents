...
import { View, StyleSheet, ScrollView, Text as NativeText } from "react-native";
...
const CallPanel = (props: Props) => {
  ...
  return (props.meetingDetails?
    
    props.meetingDetails && (props.meetingDetails.meeting_details.apidetails.select_speakers.indexOf(
    profileData.common.user.id.toString()
  ) == -1)?<> <NativeText>You are joined in Agenda session</NativeText></>:
    <>
      <View
        style={[
