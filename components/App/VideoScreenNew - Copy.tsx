...
const VideoScreenNew = (props) => {
  ...
  useEffect(() => {
    ...
    createRoom(props.login.common.user,props.route.params.meeting_id); 
   ...
   */
  const createRoom = (userdetails,meeting_id) => {
    setRoomCreateError(false);
    setAppState(AppState.Creating);
    api
      .createRoom(props.event.common.event.event_id_single, meeting_id, props.login.cookie)
      .then((room) => {
  ...
  return (appState === AppState.Creating?<ActivityIndicator size="large" color="green" />:
  appState === AppState.Joining?<ActivityIndicator size="large" color="green" />: 
    <CallObjectContext.Provider value={callObject}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          appState === AppState.Joined?<ActivityIndicator size="large" color="green" />:(
            <ScrollView
              ...
              <View style={styles.buttonContainer}>
                ...
                {roomUrlFieldValue ? (
                  ...
                  <Button
                    type="secondary"
                    onPress={createRoom}
                    label={(appState === AppState.Creating)? 'Creating room...'
                        : 'Create demo room'
                    }
                  />
                )} 
                {/* {AppState.Joined?<View></View>: */}
              {roomUrl?<ActivityIndicator color="green" size="large"/>:<StartButton
                  onPress={startCall}
