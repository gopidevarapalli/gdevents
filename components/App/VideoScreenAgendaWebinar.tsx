...
import api from "../../apiAgendaWebinar";
...
const VideoScreenAgendaWebinar = (props) => {
  console.log("videoscreen Webinar props", props);
  ...
  useEffect(() => {
    ...
    function handleNewMeetingState(event?: DailyEventObject) {
      ...
      if (event && event.action && event.action == "joined-meeting") {
        ...
        console.log("participant webinar formdata join ", formData2);

        Axios.post(`${api_url.daily_save_user_log}`, formData2)
          .then((res) => {
            console.log("participant webinar join res", res);
          })
          .catch((err) => console.log("err", err));
        ...
        console.log("participant webinar formdata left ", formData2);

        Axios.post(`${api_url.daily_save_user_log}`, formData2)
          .then((res) => {
            console.log("participant webinar left res", res);
          })
          .catch((err) => console.log("err", err));
      }
      ...
      switch (callObject?.meetingState()) {
        case "joined-meeting":
          ...
          console.log("local webinar formdata join", formData);

          Axios.post(`${api_url.daily_save_user_log}`, formData)
            .then((res) => {
              console.log("local webinar join res", res);
            })
            .catch((err) => console.log("err", err));
        ...
        case "left-meeting":
          ...
          console.log("local webinar formdata left ", formData2);

          Axios.post(`${api_url.daily_save_user_log}`, formData2)
            .then((res) => {
              console.log("local webinar left res", res);
            })
            .catch((err) => console.log("err", err));
...
export default connect(mapStateToProps)(VideoScreenAgendaWebinar);
