        ...
        .then(res=>{
          ...
          let temp = []
           temp = res.data.data.map((item)=>{
            ...
            item.type = props.login.common.user.displayname == item.display_name? "out":"in";
            return item
          });
          console.log(temp)
...
//     console.log('line 268 cookie', props.login.cookie);
//     console.log('line 268 event_id', props.event.common.event.event_id_single);
//     console.log('line 268 meeting_id', props.route.params.meeting_id.meeting_id);
//     console.log('line 268 meeting_type','videochat');

//   Axios.get("https://coe-test-events-website.pantheonsite.io/api/user/userMeetingChatHistory/",{
//     params:{ cookie:props.login.cookie,
//     event_id:props.event.common.event.event_id_single,
//     meeting_id:props.route.params.meeting_id.meeting_id,
//     meeting_type:'videochat'}
//   })
//   .then(res=>{
//     // console.log('line 275',res)
//     let temp = []
