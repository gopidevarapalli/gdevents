...
function Feed(props) {
    ...
    return (isLoading?<ActivityIndicator size={30} color="green" />:
        <View>
<ScrollView>     
        <FlatList
        ...
        renderItem={({item,index})=>{ console.log(index)
                return (
                    ...
                    <View style={styles.cardBody}>
                        ...
                        <Image style={{ height: 60, width: 60, borderRadius:50 }}  source={{uri:item.Profilepic}} />
                        ...
                        <View style={styles.cardDetails}>
                            ...
                            <Text style={{marginTop:7, flexDirection:"row"}}>{item.PostAge}</Text>
                        </View>                   
                    </View>
                    <View>
                        <Text style={{marginLeft:16, marginRight:16}}>{item.Content}</Text>
                ...
                imagesMaxWidth={Dimensions.get('window').width} />
                   ...
                   {item.comments?item.comments.map((comment,i)=>{ console.log(comment)
                   ...
                   <Text>{comment.CommentAge}</Text>
                      ...
                      <View style={{flexDirection:"row"}}>
                    <TextInput  style={{marginLeft:15}} placeholder= "Write a comment..." 
                    editable={false}
                    ...
                    <Entypo name="attachment" style={{marginTop:18, marginLeft:160}} size={16} />
                    {writeComment[index].length?<Ionicons name="send" style={{marginTop:18, marginLeft:15}} 
                    size={16}
                    onPress={()=>{
