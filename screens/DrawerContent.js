          ...
          <View style={styles.userInfoSection}>
            <View style={{ flexDirection: "row", marginTop: 15 }}>
              <Avatar.Image
                source={{
                  uri:
                    //"https://events.globaldata.com" + profileData.user.avatar,
                    // "https://events.globaldata.com" +
                    `${api_url.live_url}` + profileData.user.avatar,
                }}
                size={50}
              />
              <View
                style={{ flex: 1, marginLeft: 15, marginTop:-10, flexDirection: "column" }}
              >
                <Title style={styles.title}>
                  {store.getState().login.common.user
                    ? store.getState().login.common.user.displayname
                    : ""}
                </Title>
                <Caption style={styles.caption}>
                  {store.getState().login.common.user
                    ? store.getState().login.common.user.email
                    : ""}
                </Caption>
              </View>
            </View>
