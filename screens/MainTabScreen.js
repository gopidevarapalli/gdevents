...
import VideoScreenNew from "../components/App/VideoScreenNew";
import MessageListScreen from "./MessageListScreen";
import ContactUs from "./ContactUs";
import HelpScreen from "./HelpScreen";
import VideoScreen2 from "../components/App/VideoScreen";
import VideoScreen3 from "../components/App/VideoScreen3";
import Chat from "../components/App/Chat";
import TableBook from "./TableBook";
import VcardsListScreen from "./VcardsListScreen";
import VideoScreenNewAgenda from "../components/App/VideoScreenNewAgenda";
import AgendaVideo from "../components/AgendaVideo";
import VideoScreenAgendaSimulive from "../components/App/VideoScreenAgendaSimulive";
import AgendaRecordedVideo from "../components/AgendaRecordedVideo";
import VideoScreenAgendaWebinar from "../components/App/VideoScreenAgendaWebinar";
import VideoScreenAgendaQASimulive from "../components/App/VideoScreenAgendaQASimulive";
...
const MainTabScreen = () => {
  ...
  }, [store.getState().login.cookie, refreshRequired]);
    ...
    /> */}
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarColor: "#00dea5",
          tabBarIcon: ({ color }) => (
            <Entypo name="bookmark" color={color} size={26} />
          ),
        }}
      />
      <Tab.Screen
...
const HomeStackScreen = (props) => {
  ...
  useEffect(() => {
    console.log("Main tab screen calledd");
                ...
                <Avatar.Image
                  source={{
                    uri:
                      ...
                      `${api_url.live_url}` + props.profileData.user.avatar,
                  }}
                  size={30}
                />
              </TouchableOpacity>
...
{/* <HomeStack.Screen
      ...
      />
      <HomeStack.Screen
        name="VideoScreenNewAgenda"
        component={VideoScreenNewAgenda}
        options={({ route }) => ({
          title: "Video",
          headerBackTitleVisible: false,
          headerTitle: false,
      ...
      <HomeStack.Screen
        name="VideoScreenAgendaSimulive"
        component={VideoScreenAgendaSimulive}
        options={({ route }) => ({
          title: "Video",
          headerBackTitleVisible: false,
          headerTitle: false,
      ...
      <HomeStack.Screen
        name="VideoScreenAgendaWebinar"
        component={VideoScreenAgendaWebinar}
        options={({ route }) => ({
          title: "Video",
          headerBackTitleVisible: false,
          headerTitle: false,
      ...
      <HomeStack.Screen
        name="VideoScreenAgendaQASimulive"
        component={VideoScreenAgendaQASimulive}
        options={({ route }) => ({
          title: "Video",
          headerBackTitleVisible: false,
          headerTitle: false,
      ...
      />
      <HomeStack.Screen
        name="AgendaRecordedVideo"
        component={AgendaRecordedVideo}
        options={({ route }) => ({
          title: "Video2",
          headerBackTitleVisible: false,
          headerTitle: false,
