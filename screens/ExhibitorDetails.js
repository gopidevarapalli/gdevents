    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          <Text style={{ color: "#20c997", fontSize: 20, marginTop: 2 }}>
            Ingredion Inc
          </Text>
        ...
        <Text>
          Ingredion Inc (Ingredion) is an ingredients solutions provider. The
          company manufactures and markets sweeteners, starches, nutrition
          ingredients, and biomaterials products. Its ingredient solutions are
          used in packaged foods and prepared foods
        </Text>
        ...
        >
          <View style={{ flex: 1, borderColor: "#ddd" }}>
            <Text style={{ color: "#000", marginLeft: 10, marginTop: 5 }}>
              Company Type
            </Text>
          </View>
          <View style={{ flex: 1, borderColor: "#ddd" }}>
        ...
        >
          ...
          <View style={{ flex: 1, borderColor: "#ddd" }}>
            <Text style={{ color: "#000", marginLeft: 10, marginTop: 5 }}>
              5 Westbrook Corporate Ctr, Berkeley Square1
            </Text>
          </View>
        </View>
        <View
        ...
        >
          ...
          <View style={{ flex: 1, borderColor: "#ddd" }}>
            <Text style={{ color: "#20c997", marginLeft: 10, marginTop: 5 }}>
              www.ingredion.com/
            </Text>
          </View>
        </View>
        ...
        <View style={{ alignItems: "center" }}>
          <Text style={{ fontSize: 20 }}>Delagates</Text>
        </View>
          ...
          <View style={styles.cardBody}>
            ...
            >
              <Image
                ...
                source={{
                  uri:
                    "https://ind-backend-events-website.pantheonsite.io/wp-content/uploads/2020/07/1594022274Michael-Cares-250x250-1.jpg",
                }}
              />
            </View>
          ...
          <View style={styles.cardBody}>
            ...
            >
              <Image
                ...
                source={{
                  uri:
                    "https://ind-backend-events-website.pantheonsite.io/wp-content/uploads/2020/07/1594022739Tobias-Koehler-250x250-1.jpg",
                }}
              />
            </View>
          ...
          <View style={styles.cardBody}>
            ...
            >
              <Image
                ...
                source={{
                  uri:
                    "https://ind-backend-events-website.pantheonsite.io/wp-content/uploads/2020/07/1594030396MichaelToedt-250x350-1.jpg",
                }}
              />
            </View>
