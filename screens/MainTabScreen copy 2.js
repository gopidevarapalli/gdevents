...
useEffect(()=>{
  ...
  >
    ...
    <Tab.Screen  name="Home" options={{
        ...
        />:<HomeStackScreen profileData={profileData} screen={screen} />
        }
...
useEffect(()=>{ 
  ...
  return (isLoading?<ActivityIndicator />:
    ...
    // screen={props.screen}
    name="Home"
    initialRouteName={screen?screen:'Home'}
    navigationOptions={{
            ...
            <View style={{flexDirection: 'row', marginRight: 10}}>
              ...
              <TouchableOpacity
                ...
                <Avatar.Image
                  source={{
                    uri:
                      'https://events.globaldata.com'+props.profileData.user.avatar,
                  }}
                  size={30}
                />
              </TouchableOpacity>
